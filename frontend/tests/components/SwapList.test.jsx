...
const mockSwaps = [
  { swap_id: 1, user_id: '123', giving_course_code: 'MATH101', giving_course_name: 'Mathematics', wanted_course_code: 'PHY102', wanted_course_name: 'Physics' },
...
describe("SwapList", () => {
  ...
  it("handles swap action when confirm button is clicked", async () => {
    ...
    // Add assertions to verify the expected behavior after swap confirmation
    // For example, you might check for a success message or that the dialog has closed
  });
